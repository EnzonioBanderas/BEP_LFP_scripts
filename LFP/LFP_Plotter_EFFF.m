% Plot various graphs for an Experiment Folder Folder Folder (EFFF) 
% which is a folder containing folders containing experiment folders. 
% Does not plot LFP traces or spectrograms.
...
bandtable.Power{count}=[bandpower2(temp.Power_arr,fff,delta);...
                        ...
                        bandpower2(temp.Power_arr,fff,[Settings.HP,normFreq])];
bandtable.Targeted(count)=temptable.Targeted(find(temp.Logical_g_ii,1,'first'));
